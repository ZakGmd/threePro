...
export default function CartIcon (){
  ...
  return (
    <div className="absolute right-4 top-7  ">
      <div className=' backdrop-blur-2xl flex border backdrop-brightness-[0.80]  shadow-sm border-black/25 rounded-md hover:bg-black/10 transition-all duration-300 '>
        <button className='inline-flex items-center justify-center relative  pr-[14px] pl-3 py-2  '   onClick={() => setIsCartOpen(!isCartOpen)}>
        <ShoppingCart className="h-5 w-5 opacity-80 " color='white'/>
